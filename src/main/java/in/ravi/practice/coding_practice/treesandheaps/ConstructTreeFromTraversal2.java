...
public class ConstructTreeFromTraversal2 {
	...
	// these printInorder and printPreorder are just for verification of constructed
	// tree
	...
	public static void main(String args[]) {
		ConstructTreeFromTraversal2 constructTreeFromTraversal = new ConstructTreeFromTraversal2();
